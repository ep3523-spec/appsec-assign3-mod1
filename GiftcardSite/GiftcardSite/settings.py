...
# Moved to environment variable DJANGO_SECRET_KEY for security.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
if not SECRET_KEY:
    raise RuntimeError('DJANGO_SECRET_KEY environment variable not set. Define it in your runtime (Kubernetes Secret, local .env, or CI secret).')
